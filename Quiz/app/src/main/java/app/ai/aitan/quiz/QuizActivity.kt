...
import app.ai.aitan.quiz.databinding.ActivityQuizBinding
import app.ai.aitan.quiz.databinding.ActivityResultBinding
...
class QuizActivity : AppCompatActivity() {
    ...
    val quizLists: List<List<String>> = listOf(
        listOf("Androidコースのキャラクターは?","ランディ","フィル","ドロイド","ランディ"),
        listOf("Androidを開発する言語は?","JavaScript","Kotlin","Swift","Kotlin"),
        listOf("ImageViewが扱えるのは?","文字","音声","画像","画像")
    )
